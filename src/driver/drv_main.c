...
static driver_t g_drivers[] = {
	...
	//drvdetail:"descr":"BL0939 SPI driver for dual CT clamp bidirectional power meters. Provides voltage, current/power A/B, import/export A/B, and total import/export energy.",
	//drvdetail:"requires":""}
