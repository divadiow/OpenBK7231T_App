...
void CMD_Init_Early() {
	...
	//cmddetail:"descr":"Enables dynamic power saving mode on Beken N/T, BL602, W600 and LN882H. In the case of LN882H PowerSave will not work as a startup command so use in autoexec. On LN882H only PowerSave 1 should be used if BL0937 metering is present. You can also disable power saving with PowerSave 0.",
